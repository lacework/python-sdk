...
class EvidenceAPI(BaseEndpoint):

    def __init__(self, session):
        """
        Initializes the EvidenceAPI object.
    ...
    def get(self,
            ...
            **request_params):
        """
        A method to get Evidence objects.
    ...
    def get_pages(self,
        ...
        :return a generator which yields pages of Evidence objects returned by the Lacework API.
        """
    ...
    def get_data_items(self,
        ...
        :return a generator which yields individual Evidence objects returned by the Lacework API.
        """
    ...
    def search(self,
               json=None):
        """
        A method to search Evidence objects.
